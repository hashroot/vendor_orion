...
PRODUCT_VERSION_MINOR = Andromeda
...
# Set all versions
ORION_VERSION := OrionOS-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR)-$(ORION_BUILD_TYPE)$(ORION_POSTFIX)
ORION_MOD_VERSION := OrionOS-$(ORION_BUILD)-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR)-$(ORION_BUILD_TYPE)$(ORION_POSTFIX)
